...
# wget https://raw.githubusercontent.com/cctbx-xfel/cctbx_project/mfxlq3915/libtbx/auto_build/bootstrap.py
# or
# curl https://raw.githubusercontent.com/cctbx-xfel/cctbx_project/mfxlq3915/libtbx/auto_build/bootstrap.py > bootstrap.py
...
class ccp4io_module(SourceModule):
  module = 'ccp4io'
  anonymous = ['git', '-b mfxlq3915', 'https://github.com/cctbx-xfel/%s/archive/mfxlq3915.zip' % module ]
...
class cctbx_module(SourceModule):
  ...
  anonymous = ['git', '-b mfxlq3915',
               'git@github.com:cctbx-xfel/cctbx_project.git',
               'https://github.com/cctbx-xfel/cctbx_project.git',
               'https://github.com/cctbx-xfel/cctbx_project/archive/mfxlq3915.zip']
...
class cbflib_module(SourceModule):
  ...
  anonymous = ['git', '-b mfxlq3915',
               ...
               'https://github.com/cctbx-xfel/cbflib/archive/mfxlq3915.zip']
...
class ccp4io_adaptbx(SourceModule):
  ...
  anonymous = ['git', '-b mfxlq3915',
               ...
               'https://github.com/cctbx-xfel/ccp4io_adaptbx/archive/mfxlq3915.zip']
...
class annlib_adaptbx(SourceModule):
  ...
  anonymous = ['git', '-b mfxlq3915',
               ...
               'https://github.com/cctbx-xfel/annlib_adaptbx/archive/mfxlq3915.zip']
...
class gui_resources_module(SourceModule):
  ...
  anonymous = ['git', '-b mfxlq3915',
               ...
               'https://github.com/cctbx-xfel/gui_resources/archive/mfxlq3915.zip']
...
class dials_module(SourceModule):
  ...
  anonymous = ['git', '-b mfxlq3915',
               ...
               'https://github.com/cctbx-xfel/dials/archive/mfxlq3915.zip']
