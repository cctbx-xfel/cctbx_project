...
# wget https://raw.githubusercontent.com/cctbx-xfel/cctbx_project/mfxlq1215/libtbx/auto_build/bootstrap.py
# or
# curl https://raw.githubusercontent.com/cctbx-xfel/cctbx_project/mfxlq1215/libtbx/auto_build/bootstrap.py > bootstrap.py
...
class ccp4io_module(SourceModule):
  module = 'ccp4io'
  anonymous = ['git', '-b mfxlq1215', 'https://github.com/cctbx-xfel/%s/archive/mfxlq1215.zip' % module ]
...
class cctbx_module(SourceModule):
  ...
  anonymous = ['git', '-b mfxlq1215',
               'git@github.com:cctbx-xfel/cctbx_project.git',
               'https://github.com/cctbx-xfel/cctbx_project.git',
               'https://github.com/cctbx-xfel/cctbx_project/archive/mfxlq1215.zip']
...
class cbflib_module(SourceModule):
  ...
  anonymous = ['git', '-b mfxlq1215',
               ...
               'https://github.com/cctbx-xfel/cbflib/archive/mfxlq1215.zip']
...
class ccp4io_adaptbx(SourceModule):
  ...
  anonymous = ['git', '-b mfxlq1215',
               ...
               'https://github.com/cctbx-xfel/ccp4io_adaptbx/archive/mfxlq1215.zip']
...
class annlib_adaptbx(SourceModule):
  ...
  anonymous = ['git', '-b mfxlq1215',
               ...
               'https://github.com/cctbx-xfel/annlib_adaptbx/archive/mfxlq1215.zip']
...
class gui_resources_module(SourceModule):
  ...
  anonymous = ['git', '-b mfxlq1215',
               ...
               'https://github.com/cctbx-xfel/gui_resources/archive/mfxlq1215.zip']
...
class dials_module(SourceModule):
  ...
  anonymous = ['git', '-b mfxlq1215',
               ...
               'https://github.com/cctbx-xfel/dials/archive/mfxlq1215.zip']
